...
std::string HttpRequest::getParma(const std::string& key
            ,const std::string& def) {
...
void HttpRequest::setParma(const std::string& key, const std::string& val) {
    m_params[key] = val;
}
...
void HttpRequest::delParma(const std::string& key) {
    m_params.erase(key);
}
...
bool HttpRequest::hasParma(const std::string& key, std::string* val) {
    auto it = m_params.find(key);
    if(it == m_params.end()) {
        return false;
    }
